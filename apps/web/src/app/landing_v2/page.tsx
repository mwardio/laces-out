...
export const metadata: Metadata = {
  ...
  description: yahooComingSoon
    ? "Connect ESPN leagues for fresh forecasts and ranked fantasy football decisions."
  ...
  return (
    <div className={styles.page}>
      ...
      <main id="main-content">
            ...
            <div className={styles.heroCopy}>
              ...
              <div className={styles.heroProof} aria-label="Product availability">
                <span>
                  ...
                  {yahooComingSoon ? "ESPN" : "Yahoo + ESPN"}
                </span>
                <span>
                  <Check aria-hidden="true" size={14} /> Web + iPhone
                </span>
                <span>
        ...
        <section className={`${styles.ctaBand} ${styles.midCta}`}>
          <h2>See it on your league.</h2>
