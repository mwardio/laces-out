      ...
      <article className={styles.document}>
        ...
        <section>
          ...
          <p>
            ...
            with surviving members is preserved and ownership moves to a surviving commissioner or
            member in that order. A league with no other member is deleted. Shared synced facts,
            league-visible numeric projections, immutable change events, and bounded usage/audit
            records remain only where other members or security accounting still require them;
            direct account attribution is removed, including user identifiers embedded in surviving
            projection and cloned-ranking provenance. League Intel text last written by the member
            and Weekly Reckoning recap text generated by that member are deleted.
          </p>
          <p>
