...
import {
  ...
  HISTORICAL_ROS_DEFENSE_COHORT_ORDER_VERSION,
...
export const ROS_HISTORICAL_CORPUS_PHYSICAL_PROTOCOL = Object.freeze({
  ...
  defenseInputVersion: HISTORICAL_ROS_DEFENSE_INPUT_VERSION,
  defenseCohortOrderVersion: HISTORICAL_ROS_DEFENSE_COHORT_ORDER_VERSION,
  defenseScheduleVersion: HISTORICAL_ROS_DEFENSE_SCHEDULE_VERSION,
  defenseGameVersion: FIRST_PARTY_DEFENSE_GAME_VERSION,
  defenseCalibrationVersion: FIRST_PARTY_DEFENSE_GAME_CALIBRATION_VERSION,
  defenseAllowedDistributionVersion: FIRST_PARTY_TEAM_DEFENSE_ALLOWED_DISTRIBUTION_VERSION,
