...
function restore(
  ...
  const expectedProvenance = {
    ...
    seedHash: hash(
      `${FIRST_PARTY_ROS_SEED_VERSION}|${football.seed}|${football.inputChecksum}|${football.playerId}|${football.strategy}|${football.season}|${football.asOfWeek}|${football.asOfAt}|${football.windowStartWeek}|${football.windowEndWeek}`,
    ),
