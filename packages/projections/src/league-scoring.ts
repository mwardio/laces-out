 ...
 * Do not extend without recording evidence there first — every ESPN nonlinear ID without an entry
 * here stays pessimistically attributed to all six positions.
 */
