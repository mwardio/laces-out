...
ARG NEXT_PUBLIC_REGISTRATION_OPEN=false
ARG NEXT_PUBLIC_YAHOO_ACCESS_STATUS=pending
ARG NEXT_PUBLIC_CLOUDFLARE_ANALYTICS=disabled
ARG NEXT_PUBLIC_POSTHOG_REGION=disabled
ARG NEXT_PUBLIC_POSTHOG_PROJECT_TOKEN=
# Search-console ownership tokens. Blank renders no meta tag; DNS TXT verification is preferred and
# needs neither. See the "Search presence" section of docs/operations.md.
...
ENV NEXT_PUBLIC_API_URL=${NEXT_PUBLIC_API_URL} \
    ...
    NEXT_PUBLIC_REGISTRATION_OPEN=${NEXT_PUBLIC_REGISTRATION_OPEN} \
